...
import { socketAuthMiddleware, socketDisconnectHandler } from './middleware/socketMiddleware.js';
...
// Handle disconnect events and online status
socketDisconnectHandler(io);
